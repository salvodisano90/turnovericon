...
export default function FadeInView({ children, style, duration = 200, dy = 6, delay = 0 }: { children: React.ReactNode; style?: ViewStyle | ViewStyle[]; duration?: number; dy?: number; delay?: number }) {
  ...
  return <Animated.View style={[{ opacity: o, transform: [{ translateY: t }] }, style]}>{children}</Animated.View>;
}

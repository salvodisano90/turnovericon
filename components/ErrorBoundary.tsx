  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: '#0b0b0c', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        ...
        <Text style={{ color: '#a1a1aa', fontSize: 14, textAlign: 'center', marginBottom: 18, lineHeight: 20 }}>L'app non si è bloccata: puoi riprovare. Se il problema persiste, riavvia l'app.</Text>
        <ScrollView style={{ maxHeight: 140, alignSelf: 'stretch', marginBottom: 18 }}><Text style={{ color: '#71717a', fontSize: 12 }}>{this.state.message}</Text></ScrollView>

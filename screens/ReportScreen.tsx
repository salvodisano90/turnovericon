...
const styles = StyleSheet.create({
  ...
  kpiCard: { width: '48.5%' },
  kpiVal: { fontSize: 28, fontWeight: '800', letterSpacing: -0.5 },
  kpiLab: { fontSize: 12, fontWeight: '600', marginTop: 2 },
  adhTop: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  adhBig: { fontSize: 28, fontWeight: '800', minWidth: 76 },
  ...
  eqLab: { fontSize: 12, flex: 1, marginRight: 8 },
  ...
  simHint: { fontSize: 12, marginTop: 10, lineHeight: 18 },
});

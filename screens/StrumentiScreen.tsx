...
export default function StrumentiScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.bg, paddingBottom: insets.bottom }]}>
      <SheetHeader title="Strumenti" subtitle="Validazione · cronologia · backup" onClose={() => (router.canGoBack() ? router.back() : router.replace("/"))} />
      <ScrollView contentContainerStyle={styles.body}>
        ...
        <Card>
          ...
          <Button title="Matrici stagionali" variant="secondary" full onPress={() => router.push('/matrici-stagionali')} style={{ marginTop: 10 }} />
          <Button title="Dashboard Coordinatore" variant="secondary" full onPress={() => router.push('/dashboard')} style={{ marginTop: 10 }} />
          <Button title="Simulatore scenario" variant="secondary" full onPress={() => router.push('/simulatore')} style={{ marginTop: 10 }} />
          <Button title="Postazioni operative" variant="secondary" full onPress={() => router.push('/postazioni')} style={{ marginTop: 10 }} />
          <Button title="Centro criticità" variant="secondary" full onPress={() => router.push('/centro-criticita')} style={{ marginTop: 10 }} />
          <Button title="Dashboard Direzione" variant="secondary" full onPress={() => router.push('/direzione')} style={{ marginTop: 10 }} />
          <Button title="Banca ore" variant="secondary" full onPress={() => router.push('/banca-ore')} style={{ marginTop: 10 }} />
          <Button title="Reperibilità" variant="secondary" full onPress={() => router.push('/reperibilita')} style={{ marginTop: 10 }} />
          <Button title="Import personale" variant="secondary" full onPress={() => router.push('/import-personale')} style={{ marginTop: 10 }} />
          <Button title="Primo avvio (guida)" variant="secondary" full onPress={() => router.push('/onboarding')} style={{ marginTop: 10 }} />
          <Button title="Account" variant="secondary" full onPress={() => router.push('/account-hub')} style={{ marginTop: 10 }} />
          <Button title="Desiderata operatori" variant="secondary" full onPress={() => router.push('/desiderata')} style={{ marginTop: 10 }} />
          <Button title="Richieste e accessi (multiutente)" variant="secondary" full onPress={() => router.push('/richieste')} style={{ marginTop: 10 }} />

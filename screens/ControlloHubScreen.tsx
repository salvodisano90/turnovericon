    ...
    <AppShell title="Controllo">
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: insets.bottom + 110 }} showsVerticalScrollIndicator={false}>
        <View style={styles.row}>
          ...
          <QuickActionCard icon="stats-chart-outline" title="Dashboard Direzione" subtitle="KPI e performance" onPress={() => router.push('/direzione')} color={AREA.controllo} />
        </View>
        <View style={styles.row}>
          <QuickActionCard icon="time-outline" title="Banca Ore" subtitle="Straordinari e residui" onPress={() => router.push('/banca-ore')} color={AREA.controllo} />

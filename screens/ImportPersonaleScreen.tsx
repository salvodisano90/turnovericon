...
export default function ImportPersonaleScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.bg }]}>
      <SheetHeader title="Import personale" subtitle="Da Excel/CSV (incolla i dati)" onClose={() => router.back()} />
...
const styles = StyleSheet.create({
  ...
  sum: { fontSize: 14, fontWeight: '700', marginVertical: 1 },
  prev: { paddingVertical: 10, marginBottom: 8 },
  pNome: { fontSize: 15, fontWeight: '700' },
  pMeta: { fontSize: 12.5, marginTop: 2 },
  err: { fontSize: 12.5, marginTop: 4 },
});

...
export default function StaffDashboardScreen() {
  ...
  const ITEMS = [
    { lbl: 'I miei turni', icon: 'calendar-number-outline', to: '/i-miei-turni', sub: 'Il tuo calendario' },
    { lbl: 'Richieste', icon: 'list-outline', to: '/richieste', sub: myReq.length ? `${myReq.length} totali · ${pending} in attesa` : 'Nessuna' },

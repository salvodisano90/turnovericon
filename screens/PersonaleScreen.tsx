                  ...
                  <Pressable style={styles.bodyTap} onPress={() => router.push({ pathname: '/staff-detail', params: { infId: s.id } })}>
                    ...
                    <View style={styles.body}>
                      ...
                      <View style={styles.badges}>
                        ...
                        {(s.competenze || []).slice(0, 3).map((c: string) => <View key={c} style={[styles.miniBadge, { backgroundColor: colors.blueSoft }]}><Text style={[styles.miniTxt, { color: colors.blue }]}>{c}</Text></View>)}
                      </View>
                    </View>
                  </Pressable>

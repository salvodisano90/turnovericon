...
export default function SeasonalConfigScreen() {
  ...
  const saveCustom = () => {
    ...
    const m: Matrice = { id, label, seq: editor.seq, durata: editor.seq.length };
    addMatriceCustom(m);
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.bg }]}>
      <SheetHeader title="Matrici stagionali" subtitle="Assegna una matrice e un periodo a ogni stagione" onClose={() => router.back()} />

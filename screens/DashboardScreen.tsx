...
const styles = StyleSheet.create({
  ...
  heroSub: { fontSize: 13, fontWeight: '500', marginTop: 2, marginBottom: 16 },
  ...
  ringBigVal: { fontSize: 28, fontWeight: '800' },
  ...
  critTxt: { flex: 1, fontSize: 13, fontWeight: '600', lineHeight: 18 },
  ...
  brandTxt: { fontSize: 17, fontWeight: '800', letterSpacing: 0.5 },
  ...
  ringVal: { fontSize: 28, fontWeight: '800' },
  ringMax: { fontSize: 11, marginTop: -2 },
  analisiTitle: { fontSize: 15, fontWeight: '800' },
  analisiSub: { fontSize: 12, marginTop: 2 },
  checks: { marginTop: 8, gap: 4 },
  checkRow: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  checkTxt: { fontSize: 12, fontWeight: '600' },
  sectionTitle: { fontSize: 17, fontWeight: '800', marginTop: 18, marginBottom: 12 },
  ...
  insightTxt: { flex: 1, fontSize: 13, fontWeight: '600' },
});

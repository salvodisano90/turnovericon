  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.bg }]}>
      <ScrollView contentContainerStyle={{ paddingTop: insets.top + 8, paddingHorizontal: 16, paddingBottom: insets.bottom + 110 }} showsVerticalScrollIndicator={false}>
        ...
        {/* 3 — ASSENZE */}
        <Text style={[styles.sectionTitle, { color: colors.text }]}>Assenze</Text>
        <View style={styles.kpiRow}>
        ...
        {/* 4 — REPERIBILI */}
        <Text style={[styles.sectionTitle, { color: colors.text }]}>Reperibili</Text>
        <View style={styles.kpiRow}>
          <KPICard icon="call-outline" label="Reperibili oggi" value={reperibili === null ? '—' : `${reperibili}`} sub="Disponibilità inviate" subColor={reperibili ? colors.blue : colors.text3} />
        </View>

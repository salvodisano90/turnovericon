...
const styles = StyleSheet.create({
  fLbl: { fontSize: 12.5, fontWeight: '700', marginBottom: 6 },
  ...
  dSym: { fontSize: 18, fontWeight: '800', color: '#6EC8FF' },
  dVal: { fontSize: 16, fontWeight: '800', minWidth: 30, textAlign: 'center' },
  ...
  repEmpty: { fontSize: 13.5, marginTop: 8 },
  ...
  opNote: { fontSize: 12.5, fontWeight: '600', marginTop: 2 },

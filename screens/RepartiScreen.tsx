            ...
            return (
              <Card key={r.id}>
                ...
                <Button
                  ...
                  onPress={() => setManage({ id: r.id, nome: r.nome })}
                />
              </Card>
            );
          })
...
const styles = StyleSheet.create({
  ...
  matK: { fontSize: 12, fontWeight: '600' },
  matV: { flex: 1, fontSize: 13, fontWeight: '800', textAlign: 'right' },
  safe: { flex: 1 },
  ...
  iconTxt: { color: '#fff', fontWeight: '800', fontSize: 13 },

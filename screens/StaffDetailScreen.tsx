...
const styles = StyleSheet.create({
  ...
  ferieTxt: { fontSize: 13 },
  ferieNote: { fontSize: 11, marginTop: 1 },
  ferieEdit: { fontSize: 13, fontWeight: '700' },
  ferieDel: { fontSize: 13, fontWeight: '700' },
  cal: { flexDirection: 'row', flexWrap: 'wrap' },
  calDow: { width: `${100 / 7}%`, textAlign: 'center', fontSize: 11, fontWeight: '700', marginBottom: 4 },
  ...
  calNum: { fontSize: 11, opacity: 0.7 },
});

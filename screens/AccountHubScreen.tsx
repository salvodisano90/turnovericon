      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: insets.bottom + 110 }} showsVerticalScrollIndicator={false}>
        {user ? (
          <>
            ...
            <ActionCard icon="log-out-outline" title="Esci" desc="Disconnetti questo account" danger onPress={async () => { await signOut(); logoutSession(); router.replace('/login'); }} />
          </>
        ) : (
          <>
...
const styles = StyleSheet.create({
  ...
  guestSub: { fontSize: 13, textAlign: 'center', marginTop: 6, lineHeight: 19, paddingHorizontal: 12 },

...
import { TimeWheelField } from '../components/TimeWheel';
          ...
          <>
            ...
            {TURNS.map((t) => (
              <View key={t} style={styles.timeRow}>
                ...
                <TimeWheelField label="Inizio" value={orari[t].s} onChange={(v) => setTime(t, 's', v)} />
                <TimeWheelField label="Fine" value={orari[t].e} onChange={(v) => setTime(t, 'e', v)} />
              </View>
            ))}

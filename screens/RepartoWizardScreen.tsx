            ...
            {TURNS.map((t) => (
              <View key={t} style={styles.timeBlock}>
                ...
                <View style={styles.timeFields}>
                  <TimeStepperField label="Inizio" value={orari[t].s} onChange={(v) => setTime(t, 's', v)} />
                  <TimeStepperField label="Fine" value={orari[t].e} onChange={(v) => setTime(t, 'e', v)} />
                </View>
              </View>
            ))}
...
const styles = StyleSheet.create({
  ...
  timeFields: { flexDirection: 'column', gap: 12, marginTop: 6 },
  container: { flex: 1 },
  body: { padding: 16 },

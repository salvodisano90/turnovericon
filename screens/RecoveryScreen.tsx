...
import { passwordIssue } from '../utils/passwordPolicy';
import SheetHeader from '../components/SheetHeader';
import GlassCard from '../components/GlassCard';
import Button from '../components/Button';
import { auth, emailValid } from '../services/authProvider';
...
const inp = (c: any) => ({ borderRadius: 12, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 14, fontSize: 15, color: c.text, borderColor: c.separator, backgroundColor: c.card2 });
const styles = StyleSheet.create({
  root: { flex: 1 },
  dots: { flexDirection: 'row', gap: 8, justifyContent: 'center', marginBottom: 18 },
  dot: { width: 28, height: 6, borderRadius: 3 },
  h: { fontSize: 17, fontWeight: '800', marginBottom: 12 },

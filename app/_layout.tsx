...
import { AuthProviderComponent } from '../hooks/useAuth';
  ...
  return (
    <>
      ...
      >
        ...
        <Stack.Screen name="accesso-negato" />
        <Stack.Screen name="profilo" options={{ presentation: 'modal' }} />
        <Stack.Screen name="utenti-autorizzati" options={{ presentation: 'modal' }} />
        ...
        <Stack.Screen name="registrazione" options={{ presentation: 'modal' }} />
        <Stack.Screen name="recupero-password" options={{ presentation: 'modal' }} />
        <Stack.Screen name="account-hub" options={{ presentation: 'modal' }} />
        <Stack.Screen name="sicurezza" options={{ presentation: 'modal' }} />
        <Stack.Screen name="turni" />
        <Stack.Screen name="personale-lista" />
        <Stack.Screen name="copertura" />
        <Stack.Screen name="reparti" />
        <Stack.Screen name="report" />
        <Stack.Screen name="i-miei-turni" />

...
const dark: ThemeColors = {
  ...
  shift: {
    M: { fg: '#79B8FF', bg: 'rgba(121,184,255,0.18)' },
    P: { fg: '#F2B84B', bg: 'rgba(242,184,75,0.18)' },
    N: { fg: '#B69CFF', bg: 'rgba(182,156,255,0.18)' },
    R: { fg: 'rgba(255,255,255,0.55)', bg: 'rgba(255,255,255,0.10)' },
    S: { fg: '#64D2FF', bg: 'rgba(100,210,255,0.18)' },
    G: { fg: '#F2B84B', bg: 'rgba(242,184,75,0.18)' },
    F: { fg: '#7BC47F', bg: 'rgba(123,196,127,0.18)' },
  },
};
